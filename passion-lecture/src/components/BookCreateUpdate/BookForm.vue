...
const handleExtractUpload = (event) => {
    const file = event.target.files[0];
    formData.value.extract_file = file;
};
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-2 space-y-4">
                ...
                <div>
                    ...
                    <input v-model="formData.title" type="text" class="w-full border p-2 rounded bg-gray-100"
                ...
                <div>
                    ...
                    <div class="flex items-center border p-2 rounded bg-gray-100">
                        <input @change="handleExtractUpload" type="file"
                ...
                <div>
                    ...
                    <input v-model="formData.editor" type="text" class="w-full border p-2 rounded bg-gray-100" />
                </div>
